...
export function PostNewBook() {
    ...
    async function handleSubmit(event) { // <= Handler Function (para o botão do Formulário!)
        ...
        try {   
            await axios.post("https://ironrest.herokuapp.com/livrariaFabula", form); // to request and sent the input data stored in the state
            ...
            <FormControl style={{marginBottom: '10px'}} >
                   ...
                   <TextField
                    ...
                    <TextField
                        ...
                        onChange={handleChange}
                        />
                    <Button variant="contained" style={{marginTop: "15px"}} type="submit">Cadastrar livro</Button>
            </FormControl>
        </form>
        </div>       
